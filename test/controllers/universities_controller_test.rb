...
class UniversitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create university" do
    assert_difference('University.count') do
      post universities_url, params: { university: { name: @university.name, web_site_id: @university.web_site_id } }
    end
  ...
  test "should update university" do
    patch university_url(@university), params: { university: { name: @university.name, web_site_id: @university.web_site_id } }
